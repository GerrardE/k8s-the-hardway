...
#### Generate the K8s Client Certs & Kubelet Client Certs for 2 Worker Nodes
...
- Generate `kube-controller-manager` Client Certificate:
...
- Generate `kube-scheduler` Client Cert:
...
- Generate K8s Service Account Key Pair
